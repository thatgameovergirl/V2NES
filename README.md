...
- Output scale options (75% to 33%)
- Multi-tile VM export for large maps
- Overworld map navigation marker creator for player-position tracking
...
For bug reports or questions, open an issue on the repository.
